    ...
    return (
        <div className="single-tabs">
            <ul className="tab-list">
                <li>
                    <a href="#" className={`tab-button  ${activeTab === "desc" ? "active" : ""}`} onClick={() => handleTabClick(e,"desc")} >Description</a>
                </li>
                <li>
                    <a href="#" className={`tab-button  ${activeTab === "info" ? "active" : ""}`} onClick={() => handleTabClick(e,"info")} >
                        Additional information
                    </a>
                </li>
                <li>
                    <a href="#" className={`tab-button  ${activeTab === "review" ? "active" : ""}`} onClick={() => handleTabClick(e,"review")}>
                        Reviews
                    </a>
                </li>
            </ul>
        ...
        ${activeTab === "desc" ? "active" : ""}`} id="desc">
                ...
                <div className={`tab-panel-information content 
        ${activeTab === "info" ? "active" : ""
                ...
                <Reviews active={activeTab === "reviews" ? " content active" : ""} />
            </div>
        </div>
    )
}
